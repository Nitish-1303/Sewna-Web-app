...
export function AuthSwitch({ className, onModeChange }: AuthSwitchProps) {
  ...
  return (
    <div className={cn("flex flex-col items-center gap-6 p-8 rounded-lg", className)}>
      {/* Toggle Switch */}
      <div className="relative flex bg-gray-100 dark:bg-gray-800 p-1 rounded-full w-full max-w-xs">
        <motion.div
        ...
        <button
          ...
          className={cn(
            "relative z-10 flex-1 py-2 px-4 text-sm font-semibold rounded-full transition-colors",
            mode === 'login' ? "text-white" : "text-gray-600 dark:text-gray-400"
          )}
        >
          Login
        </button>
        ...
        <button
          ...
          className={cn(
            "relative z-10 flex-1 py-2 px-4 text-sm font-semibold rounded-full transition-colors",
            mode === 'signup' ? "text-white" : "text-gray-600 dark:text-gray-400"
          )}
        >
          Sign Up
        </button>
      ...
      >
        {mode === 'login' ? (
          <div className="space-y-4">
            ...
            <button className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg border-2 border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
          ...
          <div className="space-y-4">
            ...
            <p className="text-center text-gray-600 dark:text-gray-400">
              Join SEWNA and connect with designers
            </p>
