...
export function TubelightNavBar({ items, className }: NavBarProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 bg-white/5 dark:bg-gray-900/5 border border-gray-200 dark:border-gray-800 backdrop-blur-lg py-1 px-1 rounded-full shadow-lg">
        {items.map((item) => {
          ...
          return (
            <a
              ...
              className={cn(
                ...
                isActive && "bg-gray-100 dark:bg-gray-800 text-accent"
              )}
            >
